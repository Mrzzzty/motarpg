...
`)+`
`+g);const E=b+m+a,y=b+g+o,w=ih(i,i.VERTEX_SHADER,E),S=ih(i,i.FRAGMENT_SHADER,y);i.attachShader(v,w),i.attachShader(v,S),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function R(C){if(r.debug.checkShaderErrors){const O=i.getProgramInfoLog(v)||"",Y=i.getShaderInfoLog(w)||"",Q=i.getShaderInfoLog(S)||"",B=O.trim(),K=Y.trim(),V=Q.trim();let ee=!0,ne=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(ee=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,v,w,S);else{const fe=rh(i,w,"vertex"),ve=rh(i,S,"fragment");Xe("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
void main() {
  ...
  `};class Lx{constructor(){P(this,"composer",null);P(this,"bloomPass",null);P(this,"gradePass",null)}get ready(){return this.composer!==null}init(e,t,n,i,s){const a=U.config.postProcess,o=new Ax(e);o.setSize(i,s),o.addPass(new Rx(t,n));const l=new Ws(new Ce(i,s),a.bloom.strength,a.bloom.radius,a.bloom.threshold);l.enabled=a.bloom.enabled,o.addPass(l),this.bloomPass=l,o.addPass(new Px);const c=new sd(Ix),d=c.uniforms;d.uVignetteStrength.value=Math.min(a.vignette.strength,U.config.render.vignetteMax),d.uVignetteOffset.value=a.vignette.offset,d.uVignetteDarkness.value=a.vignette.darkness,d.uGamma.value=a.adjustment.gamma,d.uContrast.value=a.adjustment.contrast,d.uSaturation.value=a.adjustment.saturation,d.uBrightness.value=a.adjustment.brightness,c.enabled=a.vignette.enabled||a.adjustment.enabled,o.addPass(c),this.gradePass=c,this.composer=o}setSize(e,t){this.composer?.setSize(e,t),this.bloomPass?.setSize(e,t)}render(){this.composer?.render()}dispose(){this.bloomPass?.dispose(),this.gradePass?.dispose(),this.composer?.dispose(),this.composer=null,this.bloomPass=null,this.gradePass=null}}const ra=new Lx,Mh=2,Dx=1.5,Fx={start:16773853,combat:16757575,elite:16751164,chest:16765286,merchant:16771524,blacksmith:16756832,witch:13077759,boss:16734794,end:12376319,rest:16771524,corridor:16746564},Ux=4,Nx=12,Ox=6,kx=.1,Bx=.55,bh=16,Bt=class Bt{constructor(){P(this,"hoverTile",null);P(this,"renderer",null);P(this,"scene",null);P(this,"camera",null);P(this,"container",null);P(this,"raycaster",new dp);P(this,"ready",!1);P(this,"builtFloorId",-1);P(this,"floorGroup",new zt);P(this,"wallGroup",new zt);P(this,"entityGroup",new zt);P(this,"particleGroup",new zt);P(this,"hoverMesh",null);P(this,"playerSprite",null);P(this,"heroAnimator",null);P(this,"heroBaseW",1);P(this,"heroFacesLeft",!0);P(this,"playerShadow",null);P(this,"gates",[]);P(this,"wallCells",new Map);P(this,"fadeCells",new Map);P(this,"fadePool",[]);P(this,"fadeScanTimer",0);P(this,"focusX",0);P(this,"focusZ",0);P(this,"focusInit",!1);P(this,"lastTimeMs",0);P(this,"shakeTime",0);P(this,"shakeTotal",0);P(this,"shakeIntensity",0);P(this,"ambient",null);P(this,"dirLight",null);P(this,"starField",null);P(this,"starMat",null);P(this,"moonGroup",null);P(this,"playerTorch",null);P(this,"torchLights",new Map);P(this,"glowLights",new Map);P(this,"glowSprites",[]);P(this,"dustItems",[]);P(this,"heroVis",{x:0,z:0,init:!1})}static getInstance(){return Bt.instance||(Bt.instance=new Bt),Bt.instance}async init(e){this.container=e;const t=e.clientWidth||window.innerWidth,n=e.clientHeight||window.innerHeight,i=new kf;i.background=new Oe(0),this.scene=i;const s=U.config.camera3D,a=new tn(s.fov,t/n,.1,200);this.camera=a;let o;try{o=new ox({antialias:!0})}catch(l){console.error("[Three] WebGL 初始化失败",l),e.innerHTML='<div style="padding:24px;color:#ff8888">当前环境不支持 WebGL，无法启动游戏渲染。</div>';return}o.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),o.setSize(t,n),o.shadowMap.enabled=!0,o.shadowMap.type=wh,o.outputColorSpace=Pt,o.toneMapping=Ta,o.toneMappingExposure=1.15,o.domElement.id="game-canvas",o.domElement.style.width="100%",o.domElement.style.height="100%",o.domElement.style.display="block",o.domElement.style.cursor="crosshair",e.appendChild(o.domElement),this.renderer=o,this.setupLights(),i.add(this.floorGroup,this.wallGroup,this.entityGroup,this.particleGroup),this.buildHoverMesh(),this.buildStars(),ra.init(o,i,a,t,n),Xs.getInstance().attachCanvas(o.domElement),this.ready=!0,this.rebuildFloor(),X.on("floorChanged",()=>this.rebuildFloor()),X.on("saveLoaded",()=>this.rebuildFloor()),X.on("gameRestarted",()=>this.rebuildFloor()),X.on("monsterDefeated",()=>this.rebuildEntities()),X.on("chestOpened",()=>this.rebuildEntities()),X.on("potionPicked",()=>this.rebuildEntities()),X.on("battleEnded",l=>{l.result.damageTaken>Ee.getInstance().maxHp*.3&&this.shake(.3,320)}),X.on("bossDefeated",()=>this.shake(.45,520)),X.on("playerDied",()=>this.shake(.35,420)),window.addEventListener("resize",()=>this.resize())}setupLights(){if(!this.scene)return;this.ambient=new ip(5069426,2366226,.6),this.scene.add(this.ambient);const e=new ap(14674431,.55);e.position.set(Bt.MOON_OFFSET.x,Bt.MOON_OFFSET.y,Bt.MOON_OFFSET.z),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.near=.5,e.shadow.camera.far=140;const t=24;e.shadow.camera.left=-t,e.shadow.camera.right=t,e.shadow.camera.top=t,e.shadow.camera.bottom=-t,e.shadow.bias=-6e-4,e.shadow.normalBias=.02,e.shadow.radius=4,this.scene.add(e),this.scene.add(e.target),this.dirLight=e,this.moonGroup=new zt;const n=new qn(new Rn({map:An(gn.moonDisc()),transparent:!0,depthWrite:!1,fog:!1}));n.scale.set(7,7,1),this.moonGroup.add(n);const i=new qn(new Rn({map:An(gn.glow("rgba(225,235,255,0.85)")),blending:Wn,transparent:!0,depthWrite:!1,fog:!1,opacity:.38}));i.scale.set(24,24,1),i.renderOrder=-1,this.moonGroup.add(i),this.moonGroup.position.set(Bt.MOON_OFFSET.x,Bt.MOON_OFFSET.y,Bt.MOON_OFFSET.z),this.scene.add(this.moonGroup),this.playerTorch=new ho(16751165,1.5,10),this.playerTorch.decay=1.5,this.playerTorch.castShadow=!0,this.playerTorch.shadow.mapSize.set(1024,1024),this.playerTorch.shadow.bias=-.002,this.scene.add(this.playerTorch)}buildStars(){if(!this.scene)return;const e=520,t=new Float32Array(e*3),n=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){const o=Math.random()*2-1,l=Math.random()*Math.PI*2,c=110+Math.random()*60,d=Math.sqrt(1-o*o);t[a*3]=c*d*Math.cos(l),t[a*3+1]=c*o,t[a*3+2]=c*d*Math.sin(l),n[a]=Math.random(),i[a]=1.2+Math.random()*Math.random()*4.5}const s=new Lt;s.setAttribute("position",new qt(t,3)),s.setAttribute("aPhase",new qt(n,1)),s.setAttribute("aSize",new qt(i,1)),this.starMat=new Ut({uniforms:{uTime:{value:0}},transparent:!0,depthWrite:!1,blending:Wn,vertexShader:`
