...
var relics_default = {
  ...
  merchantPrices: { "0": 80, "1": 250, "2": 900, "3": 3500 },
  ...
  relics: [
    ...
    { id: "R004", name: "\u517D\u9AA8\u9879\u94FE", rarity: 1, category: "combat", desc: "\u751F\u547D\u4E0A\u9650 +25", effects: [{ type: "stat", stat: "maxHp", value: 25, mode: "flat" }], note: "\u547D\u94FE\xB7\u4E0B\u4F4D" },
    ...
    { id: "R012", name: "\u5148\u653B\u4E4B\u5203", rarity: 2, category: "combat", desc: "\u6BCF\u5C42\u9996\u6B21\u653B\u51FB\u4F24\u5BB3 \xD72", effects: [{ type: "passive", stat: "firstStrikeDouble", value: 2 }] },
    { id: "R013", name: "\u8346\u68D8\u4E4B\u7532", rarity: 2, category: "combat", combos: ["fortress"], desc: "\u53CD\u5F39\u6240\u53D7\u4F24\u5BB3\u7684 12%", effects: [{ type: "stat", stat: "thorns", value: 12, mode: "flat" }], note: "\u5821\u5792\u7EC4\u5408\u4EF6" },
    { id: "R014", name: "\u5438\u8840\u7360\u7259", rarity: 1, category: "combat", combos: ["bloodrage"], desc: "\u6BCF\u6B21\u51FB\u6740\u56DE\u590D 6 \u70B9\u751F\u547D", effects: [{ type: "onKill", action: "heal", value: 6 }], note: "\u8840\u6012\u7EC4\u5408\u4EF6" },
    { id: "R015", name: "\u91CD\u9524", rarity: 2, category: "combat", desc: "\u653B\u51FB +18%\uFF0C\u95EA\u907F -5%", effects: [{ type: "stat", stat: "attack", value: 18, mode: "percent" }, { type: "stat", stat: "dodgeRate", value: -5, mode: "flat" }] },
    { id: "R016", name: "\u7834\u6CD5\u8005", rarity: 3, category: "combat", desc: "\u5BF9\u7CBE\u82F1\u4E0E Boss \u7684\u4F24\u5BB3 +25%", effects: [{ type: "passive", stat: "eliteBossDamage", value: 25 }] },
    ...
    { id: "R019", name: "\u5723\u6CC9\u4E4B\u74F6", rarity: 2, category: "survival", combos: ["immortal"], desc: "\u836F\u6C34\u56DE\u590D\u91CF +25%", effects: [{ type: "stat", stat: "potionBonus", value: 25, mode: "flat" }], note: "\u6CC9\u94FE\xB7\u4E0B\u4F4D\uFF1B\u4E0D\u673D\u7EC4\u5408\u4EF6" },
    ...
    { id: "R022", name: "\u6FD2\u6B7B\u672C\u80FD", rarity: 2, category: "survival", desc: "\u751F\u547D\u4F4E\u4E8E 25% \u65F6\u95EA\u907F +25%", effects: [{ type: "onLowHp", stat: "dodgeRate", value: 25, mode: "flat", threshold: 0.25 }] },
    { id: "R023", name: "\u4E0D\u706D\u4E4B\u9B42", rarity: 3, category: "survival", desc: "\u6B7B\u4EA1\u65F6\u539F\u5730\u590D\u6D3B\u5E76\u6062\u590D 45% \u751F\u547D\uFF08\u6BCF\u8F6E\u722C\u5854\u9650\u4E00\u6B21\uFF09", effects: [{ type: "passive", stat: "revive", value: 45 }] },
    { id: "R024", name: "\u6696\u7089", rarity: 1, category: "survival", desc: "\u6BCF\u5C42\u56DE\u590D 3 \u70B9\u751F\u547D", effects: [{ type: "onFloorEnter", action: "heal", value: 3 }] },
    { id: "R025", name: "\u5B88\u62A4\u4E4B\u79CD", rarity: 1, category: "survival", desc: "\u6BCF 5 \u5C42\u83B7\u5F97\u4E00\u5C42\u62A4\u76FE\uFF0C\u53EF\u5438\u6536 20 \u70B9\u4F24\u5BB3", effects: [{ type: "passive", stat: "shieldEvery5", value: 20 }] },
    ...
    { id: "R027", name: "\u8D2A\u5A6A\u4E4B\u624B", rarity: 2, category: "economy", desc: "\u91D1\u5E01\u83B7\u53D6 +45%\uFF0C\u602A\u7269\u653B\u51FB +8%", effects: [{ type: "stat", stat: "goldBonus", value: 45, mode: "flat" }, { type: "passive", stat: "monsterAttackUp", value: 8 }] },
    ...
    { id: "R030", name: "\u5546\u4EBA\u53CB\u8C0A", rarity: 2, category: "economy", combos: ["rich"], desc: "\u5546\u5E97\u4EF7\u683C -20%", effects: [{ type: "stat", stat: "merchantDiscount", value: 20, mode: "flat" }], note: "\u5BCC\u5546\u7EC4\u5408\u4EF6" },
    { id: "R031", name: "\u5B66\u8005\u4E4B\u77B3", rarity: 2, category: "economy", desc: "\u7ECF\u9A8C\u83B7\u53D6 +20%", effects: [{ type: "stat", stat: "expBonus", value: 20, mode: "flat" }] },
    { id: "R032", name: "\u62FE\u8352\u8005", rarity: 3, category: "economy", desc: "\u51FB\u6740\u602A\u7269\u989D\u5916\u6389\u843D\u91D1\u5E01\uFF08\u968F\u5C42\u6570\u9012\u589E\uFF09", effects: [{ type: "onKill", action: "killGold" }] },
    { id: "R033", name: "\u70B9\u91D1\u6307", rarity: 3, category: "economy", desc: "\u91D1\u5E01\u83B7\u53D6 +30%\uFF0C\u4F46\u6BCF\u5C42\u5F00\u59CB\u635F\u5931 1% \u6700\u5927\u751F\u547D", effects: [{ type: "stat", stat: "goldBonus", value: 30, mode: "flat" }, { type: "onFloorEnter", action: "hpLossPct", value: 1 }] },
    ...
    { id: "R041", name: "\u8BC5\u5492\u4E4B\u955C", rarity: 2, category: "risk", desc: "\u653B\u51FB +30%\uFF0C\u4F46\u6BCF\u5C42\u5F00\u59CB\u635F\u5931 2% \u6700\u5927\u751F\u547D", effects: [{ type: "stat", stat: "attack", value: 30, mode: "percent" }, { type: "onFloorEnter", action: "hpLossPct", value: 2 }] },
    ...
    { id: "R043", name: "\u6DF7\u6C8C\u9AB0\u5B50", rarity: 3, category: "risk", desc: "\u6BCF\u6B21\u6218\u6597\u968F\u673A\u4F7F\u4E00\u9879\u5C5E\u6027 +20% \u6216 -15%", effects: [{ type: "passive", stat: "chaos", value: 1 }] },
    ...
    { id: "R045", name: "\u8D1F\u91CD\u8BC5\u5492", rarity: 3, category: "risk", desc: "\u9632\u5FA1 +50%\uFF0C\u95EA\u907F -20%", effects: [{ type: "stat", stat: "defense", value: 50, mode: "percent" }, { type: "stat", stat: "dodgeRate", value: -20, mode: "flat" }] },
    ...
    { id: "R052", name: "\u827E\u767B\u7684\u70DF\u6597", rarity: 0, category: "fun", desc: "\u65E0\u4EFB\u4F55\u6548\u679C\uFF08\u5F15\u5BFC\u8005\u5F69\u86CB\uFF09", effects: [{ type: "none" }], note: "\u5F69\u86CB\uFF1B\u4E0E NPC \u827E\u767B\u547C\u5E94" },
    ...
    { id: "H001", name: "\u8361\u9B54\u4E49\u65D7", rarity: 4, category: "combat", desc: "\u6BCF\u51FB\u6740\u4E00\u540D\u654C\u4EBA\uFF0C\u653B\u51FB\u529B +2%\uFF08\u672C\u8F6E\u6301\u7EED\u7D2F\u79EF\uFF09", effects: [{ type: "onKill", action: "killAttackPct", value: 2 }], note: "\u5929\u5802\u9057\u7269\xB7\u5360\u4F4D/\u6D4B\u8BD5\u7528\uFF1B\u4F20\u95FB\u53E4\u4EE3\u66FE\u53D1\u8D77 60 \u5E74\u8361\u9B54\u6240\u7559\u4E0B\u7684\u65D7\u5E1C" },
    ...
    { id: "R065", name: "\u6447\u7BEE", rarity: 3, category: "survival", exclusive: true, desc: "\u751F\u547D\u4E0A\u9650 +100%\uFF0C\u653B\u51FB +20%\uFF0C\u9632\u5FA1 +20%\uFF0C\u7ECF\u9A8C\u83B7\u53D6 +20%\uFF0C\u91D1\u5E01\u83B7\u53D6 +50%", effects: [{ type: "stat", stat: "maxHp", value: 100, mode: "percent" }, { type: "stat", stat: "attack", value: 20, mode: "percent" }, { type: "stat", stat: "defense", value: 20, mode: "percent" }, { type: "stat", stat: "expBonus", value: 20, mode: "flat" }, { type: "stat", stat: "goldBonus", value: 50, mode: "flat" }], note: "\u300C\u6447\u7BEE\u66F2\u300D\u96BE\u5EA6\u5F00\u5C40\u4E13\u5C5E\uFF08\u4E0D\u968F\u673A\u6389\u843D\uFF09\xB7 \u68A6\u4E2D\u7684\u6447\u7BEE" },
    ...
    { id: "X009", name: "\u547D\u5B9A\u4E4B\u6B7B", rarity: -1, subtype: "start", category: "risk", exclusive: true, desc: "\u7B49\u5F85\u4F60\u7684\u6B7B\u4EA1\u7684\u5230\u6765", effects: [{ type: "none" }], note: "\u5267\u60C5\u9057\u7269\xB7\u65E0\u5B9E\u9645\u6548\u679C\uFF1B\u300C\u5929\u5802\u300D\u96BE\u5EA6\u5F00\u5C40\u6301\u6709\uFF0C\u547D\u8FD0\u4E3B\u5BB0\u6240\u6709\u4EBA" }
  ],
  combos: [
...
var MapGenerator = class _MapGenerator {
  ...
  carveCliffs(rooms, grid, floorId) {
    ...
    for (const room of rooms) {
      ...
      const doorInners = room.doors.map((d) => this.innerOfDoor(d));
      const candidates = [];
      for (let y = room.y + 1; y <= room.y + room.height - 2; y++) {
        for (let x = room.x + 1; x <= room.x + room.width - 2; x++) {
          if (grid[y]?.[x] !== 0) continue;
          const nearDoor = doorInners.some((p) => Math.abs(x - p.x) <= 1 && Math.abs(y - p.y) <= 1);
  ...
  growCliffPatch(anchor, size, allowed) {
    ...
    while (patch.length < size) {
      const frontier = allowed.filter((p) => allowedSet.has(key(p)) && !inPatch.has(key(p)) && patch.some((q) => Math.abs(q.x - p.x) + Math.abs(q.y - p.y) === 1));
  ...
  roomStillConnected(room, grid) {
    ...
    const doorInners = room.doors.map((d) => this.innerOfDoor(d)).filter((p) => grid[p.y]?.[p.x] === 0);
...
// src/test/tmpCliffDebug.ts
dataManager.loadAll();
var gen = MapGenerator.getInstance();
for (let i = 0; i < 300; i++) {
  const floor = gen.generate(4);
  const { grid } = floor;
  ...
  while (queue.length > 0) {
    ...
    for (const [dx, dy] of [[0, 1], [0, -1], [1, 0], [-1, 0]]) {
      ...
      if (grid[ny][nx] !== 0 || seen.has(k)) continue;
      seen.add(k);
      queue.push({ x: nx, y: ny });
    }
  }
  ...
  for (const room of floor.rooms) {
    for (const d of room.doors) if (!seen.has(`${d.x},${d.y}`)) bad = `\u95E8 ${d.x},${d.y} \u623F${room.id}(${room.type})`;
    for (const e of room.entities) {
      if ((e.kind === "stair" || e.kind === "npc" || e.kind === "chest" || e.kind === "monster" || e.kind === "boss") && !seen.has(`${e.x},${e.y}`)) {
        bad = `\u5B9E\u4F53 ${e.kind} ${e.x},${e.y} \u623F${room.id}(${room.type})`;
      }
    }
  }
  if (!bad) continue;
  console.log("\u274C \u7B2C", i, "\u6B21\u751F\u6210\u4E0D\u53EF\u8FBE\uFF1A", bad);
  console.log("\u5165\u53E3", floor.entryX, floor.entryY);
  for (const room of floor.rooms) {
    console.log(`\u623F ${room.id} ${room.type} rect(${room.x},${room.y},${room.width}x${room.height}) \u95E8${JSON.stringify(room.doors.map((d) => `${d.x},${d.y}:${d.direction}`))}`);
  }
  for (let row = 0; row < floor.height; row++) {
    let line = "";
    for (let col = 0; col < floor.width; col++) {
      const t = grid[row][col];
      const isEntry = col === floor.entryX && row === floor.entryY;
      const reach = seen.has(`${col},${row}`);
      line += isEntry ? "E" : t === -1 ? " " : t === 1 ? "#" : t === 2 ? "o" : t === 4 ? "X" : reach ? "." : "~";
    }
