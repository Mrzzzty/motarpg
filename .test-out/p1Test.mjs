    ...
    for (const room of floor.rooms) {
      if (room.type === "chest") {
        ...
        for (const chest of room.entities.filter((e) => e.kind === "chest")) {
          const guarded = room.entities.some((e) => (e.kind === "monster" || e.kind === "boss") && manhattan(e, chest) <= 2);
      ...
      if (room.type === "end" && floor.kind === "normal") {
        ...
        if (stair) {
          const guarded = room.entities.some((e) => (e.kind === "monster" || e.kind === "boss") && manhattan(e, stair) <= 3);
